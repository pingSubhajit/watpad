	...
	return (
		<main className="flex flex-col items-start justify-center gap-8 min-h-lvh w-full mx-auto max-w-[600px] px-8 py-16">
			<header className="flex justify-between items-center w-full">
				<Link href="/">
					<Image src="/logo.svg" alt="Watpad logo" width={180} height={38} className="w-24 invert dark:invert-0"/>
				</Link>
			</header>

			<div>
				<h2 className="text-lg dark:text-neutral-200 font-medium">Watpad: Word Association Test Practice</h2>
				<p className="mt-2 text-[15px] font-medium text-muted-foreground font-sans leading-relaxed">
			...
			<div>
				<h2 className="text-lg dark:text-neutral-200 font-medium">About</h2>
				<p className="mt-2 text-[15px] font-medium text-muted-foreground font-sans leading-relaxed">
			...
			<div>
				<h2 className="text-lg dark:text-neutral-200 font-medium">AI Feedback</h2>
				<p className="mt-2 text-[15px] font-medium text-muted-foreground font-sans leading-relaxed">
					...
					To use it, go to the <Link href="/" className="text-cyan-500 dark:text-cyan-300 hover:text-cyan-400
					transition"> home page</Link> and click on the button in the bottom right-hand corner or simply
					press "A" on your keyboard
				</p>
			</div>

			<div>
				<h2 className="text-lg dark:text-neutral-200 font-medium">Contribute</h2>
				<p className="mt-2 text-[15px] font-medium text-muted-foreground font-sans leading-relaxed">
